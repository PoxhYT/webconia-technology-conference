...
<body>
	...
	<script>
		...
		const IsAnyInputIsNull = false;

		// function CheckIfAnyInputIsNull() {
		...
		button.addEventListener("click", async (event) => {
			...
			// const response = await fetch("https://api.rosemite.cf:7005/register", options);
	...
	<script>
		// api url
		const api_url =
			"https://api.rosemite.cf:7005/customers/Java-Konferenz";
